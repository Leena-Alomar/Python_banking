...
class Customer():
    ...
    def new_customer(self):
        try:
            ...
            add_new_row(type_acct=new_account_type, first_name=new_account_first_name, last_name=new_account_last_name, password=new_account_pass)
            # quit program
...
def add_new_row(type_acct, first_name, last_name, password ):
    acct_types = {"1": "checking", "2": "savings"}
    type_acct = acct_types[type_acct]
    
    print(type_acct, first_name, last_name, password)



    try:
        new_row = { 'account_id': '100010', 'first_name': first_name, 'last_name': last_name, 'password': password ,'checking': "", 'savings': ""}
        new_row[type_acct] = 0
